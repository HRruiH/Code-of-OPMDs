...
def main():
    ...
    # 创建模型
    model = resnet101(num_classes=3).to(device)

    # 加载模型权重
    model_weight_path = './best_resNet101.pth'
    ...
    plt.title('Confusion Matrix - Resnet101', fontsize=20)  # 图表标题，字体大小设置为 20
    ...
    plt.title('ROC Curve - Resnet101', fontsize=20)
