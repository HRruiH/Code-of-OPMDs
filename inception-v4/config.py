...
if mode == "train":
    # Dataset address
    train_image_dir = "../data_3/train"
    valid_image_dir = "../data_3/val"
    ...
    pretrained_model_weights_path = "./InceptionV4-ImageNet_1K-2069673f.pth.tar"
...
if mode == "test":
    ...
    model_weights_path = "./results/inception_v4-ImageNet_1K/best.pth.tar"
