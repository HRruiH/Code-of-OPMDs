...
def main():
    ...
    # 创建模型
    model = densenet169(num_classes=3).to(device)
    ...
    plt.title('Confusion Matrix - Densenet169', fontsize=20)  # 图表标题，字体大小设置为 20
    ...
    plt.title('ROC Curve - Densenet169', fontsize=20)
