...
def read_split_data(root: str):
    ...
    assert os.path.exists(train_root), "train dataset root: {} does not exist.".format(train_root)
    assert os.path.exists(val_root), "val dataset root: {} does not exist.".format(val_root)
    assert os.path.exists(val_root), "val dataset root: {} does not exist.".format(test_root)
